        ...
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'Logged in successfully!'); // redirect the user to the homepage
...
var stripe = Stripe('pk_test_PsCCmwD00N7bBFALw9dPoZJv00JIjp4aPZ');
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "5573" + '/');
